...
> 泉的个人 Python 练习仓库 —— 从爬虫到数据分析，从自动化到小游戏，边学边玩边沉淀。
...
这个仓库记录了我（泉）学习 Python 的点点滴滴。  
代码可能不完美，但每一行都是亲手敲出来的 —— 从 `print("Hello World")` 到能跑通的小爬虫、小游戏、小分析项目。如果你也在学 Python，希望这里能给你一些灵感 💡
...
- 🎓 大二在读，大数据管理与应用专业
- 🐍 Python 学习者，正在往数据分析 + 自动化办公方向摸索
- 🦖 业余时间还在捣鼓 Cocos Creator 小游戏
- 📦 偶尔接点网站外包小单子
